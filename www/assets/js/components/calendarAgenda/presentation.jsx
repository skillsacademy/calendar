    ...
    return (
      <section className="calendarAgenda">
      	...
      	<div className="rowBlock">
            ...
            <button className="addAgenda"  onClick={event => this.props.onClickAddAgenda(event)} >Add Agenda</button>
      </section>
    )
  }
}

ComponentXPresentation.propTypes = {
  onClickAddAgenda: PropTypes.func.isRequired
}
